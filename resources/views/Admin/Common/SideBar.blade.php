            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                ...
                <div class="menu-item pt-5">
                    <div class="menu-content">
                        <span class="menu-heading fw-bold text-uppercase fs-7">Pages   ccvcvcb</span>
                    </div>
                </div>
                <!--end:Menu Title item-->
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <!--begin:Menu item-->
                        <div class="menu-item">
                            <a class="menu-link" href="/user-create">
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <!--begin:Menu item-->
                        <div class="menu-item">
                            <a class="menu-link" href="/department-create">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Department Create</span>
                            </a>
                        </div>
                        <!--end:Menu item-->
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <!--begin:Menu item-->
                        <div class="menu-item">
                            <a class="menu-link" href="/store-create">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Store Create</span>
                            </a>
                        </div>
                        <!--end:Menu item-->
                ...
                <div class="menu-item menu-accordion">
                    <a class="menu-link" href="/category-create">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M20 14H18V10H20C20.6 10 21 10.4 21 11V13C21 13.6 20.6 14 20 14ZM21 19V17C21 16.4 20.6 16 20 16H18V20H20C20.6 20 21 19.6 21 19ZM21 7V5C21 4.4 20.6 4 20 4H18V8H20C20.6 8 21 7.6 21 7Z" fill="currentColor" />
                ...
                <!--begin:Menu item-->
                <div class="menu-item menu-accordion">
                    <a class="menu-link" href="/unite-create">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M20 14H18V10H20C20.6 10 21 10.4 21 11V13C21 13.6 20.6 14 20 14ZM21 19V17C21 16.4 20.6 16 20 16H18V20H20C20.6 20 21 19.6 21 19ZM21 7V5C21 4.4 20.6 4 20 4H18V8H20C20.6 8 21 7.6 21 7Z" fill="currentColor" />
                        ...
                        <span class="menu-title">Unite Setup</span>
                    </a>
                </div>
                <!--end:Menu item-->
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <!--begin:Menu item-->
                        <div class="menu-item">
                            <a class="menu-link" href="/property-type-create">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Property Create</span>
                            </a>
                        </div>
                        <!--end:Menu item-->
                        ...
                        <!--begin:Menu item-->
                        <div class="menu-item">
                            <a class="menu-link" href="/property-type-list">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                ...
                <!--begin:Menu Title item-->
                <div class="menu-item pt-5">
                    <!--begin:Menu Title content-->
                    <div class="menu-content">
                        <span class="menu-heading fw-bold text-uppercase fs-7">App CoC</span>
                    </div>
                    <!--end:Menu Title content-->
                </div>
                <!--end:Menu Title item-->
