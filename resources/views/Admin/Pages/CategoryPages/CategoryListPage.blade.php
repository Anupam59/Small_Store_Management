                        ...
                        <div class="card-body py-4">
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                ...
                                @foreach($Category as $CategoryI)
                                    <tr>
                                        <td>{{ $CategoryI->category_id }}</td>

                                        <td>{{ $CategoryI->category_name }}</td>

                                        <td><div class="badge badge-light fw-bold">{{ $CategoryI->name }}</div></td>

                                        @if($CategoryI->status == 1)
                                            <td><div class="badge badge-light-success fw-bold">Active</div></td>
                                        @elseif($CategoryI->status == 2)
                                            <td><div class="badge badge-light-danger fw-bold">Inactive</div></td>
                                        @endif

                                        <td>{{ $CategoryI->created_date }}</td>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="/category-edit/{{ $CategoryI->category_id }}" class="menu-link px-3">Edit</a>
                                                </div>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
