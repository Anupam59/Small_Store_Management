                ...
                <div class="row">
                    <div class="card mb-5 mb-xl-8">
                        <div class="card-body">
                            ...
                            <form action="{{ route('consumer-type.entry')}}" method="post" class="form" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="fv-row mb-5 fv-plugins-icon-container">
                                            ...
                                            <input type="text" class="form-control form-control-lg form-control-solid" name="consumer_type_name" placeholder="" value="" required>
                                        </div>
                                    </div>
