            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Consumer Type List</li>
                        <!--end::Item-->
                        ...
                        <div class="card-body py-4">
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                ...
                                <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-125px">Consumer Type</th>
                                ...
                                @foreach($ConsumerType as $ConsumerT)
                                    <tr>
                                        <td>{{ $ConsumerT->consumer_type_id }}</td>

                                        <td>{{ $ConsumerT->consumer_type_name }}</td>

                                        <td><div class="badge badge-light fw-bold">{{ $ConsumerT->name }}</div></td>

                                        @if($ConsumerT->status == 1)
                                            <td><div class="badge badge-light-success fw-bold">Active</div></td>
                                        @elseif($ConsumerT->status == 2)
                                            <td><div class="badge badge-light-danger fw-bold">Inactive</div></td>
                                        @endif

                                        <td>{{ $ConsumerT->created_date }}</td>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="/consumer-type-edit/{{ $ConsumerT->consumer_type_id }}" class="menu-link px-3">Edit</a>
                                                </div>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-7 d-flex align-items-center justify-content-center justify-content-md-end">
                                    <div class="dataTables_paginate paging_simple_numbers" id="kt_table_users_paginate">
                                        ...
                                        {{ $ConsumerType->onEachSide(3)->links('Admin.Common.Paginate') }}
