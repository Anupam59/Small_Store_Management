                ...
                <div class="row">
                    <div class="card mb-5 mb-xl-8">
                        <div class="card-body">
                            ...
                            <form action="{{ url('/consumer-type-update/'.$ConsumerType->consumer_type_id)}}" method="post" class="form" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="fv-row mb-5 fv-plugins-icon-container">
                                            ...
                                            <input type="text" class="form-control form-control-lg form-control-solid" name="consumer_type_name" placeholder="" value="{{ $ConsumerType->consumer_type_name }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="fv-row mb-5 fv-plugins-icon-container">
                                            ...
                                            <select name="status" aria-label="Select a Timezone" data-control="select2" data-placeholder="Select Role" class="form-control form-control-lg form-control-solid" required>
                                                <option value="1" @if($ConsumerType->status == "1") {{ 'selected' }} @endif>Active</option>
                                                <option value="2" @if($ConsumerType->status == "2") {{ 'selected' }} @endif>Inactive</option>
                                            </select>
                                        </div>
                                    </div>
