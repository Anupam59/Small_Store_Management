        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Product Distribute</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Product Distribute</li>
                        <!--end::Item-->
                ...
                <div class="row">
                    <div class="card mb-5 mb-xl-8">
                        <div class="card-body">
                            ...
                            <form action="{{ route('product.distribute.entry')}}" method="post" class="form" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="fv-row mb-5 fv-plugins-icon-container">
                                            ...
                                            <select name="product_id" aria-label="Select a Timezone" data-control="select2" data-placeholder="Select Product" class="form-control form-control-lg form-control-solid" required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="fv-row mb-5 fv-plugins-icon-container">
                                            ...
                                            <input type="number" class="form-control form-control-lg form-control-solid" min="1" name="quantity" placeholder="" value="" required>
                                        </div>
                                    </div>
