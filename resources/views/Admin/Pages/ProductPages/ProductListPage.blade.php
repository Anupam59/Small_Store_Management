                            ...
                            <div class="row px-7 py-5">
                                ...
                                <div class="col-md-2">
                                    <div class="fv-row mb-5 fv-plugins-icon-container">
                                        ...
                                        <select id="CategoryId" aria-label="Select a Timezone" data-control="select2" data-placeholder="Select Category" class="form-control form-control-lg form-control-solid">
                                            <option value=" ">Select Category</option>
                                            @if(!$Category->isEmpty())
                                                @foreach($Category as $CategoryItem)
                                                    <option value="{{ $CategoryItem->category_id }}" @if( Request::get('category_id') == $CategoryItem->category_id) {{ 'selected' }} @endif >{{ $CategoryItem->category_name }}</option>
                                                @endforeach
                                            @else
                                        ...
                                        <select id="StoreId" aria-label="Select a Timezone" data-control="select2" data-placeholder="Select Store" class="form-control form-control-lg form-control-solid">
                                            ...
                                            @if(!$Store->isEmpty())
                                                @foreach($Store as $StoreItem)
                                                    <option value="{{ $StoreItem->store_id }}" @if( Request::get('store_id') == $StoreItem->store_id) {{ 'selected' }} @endif >{{ $StoreItem->store_name }}</option>
                                                @endforeach
                                            @else
                                ...
                                <div class="col-md-3">
                                    <div class="fv-row mb-5 fv-plugins-icon-container">
                                        ...
                                        <label class="invisible align-items-center fs-5 fw-semibold mb-2">
                                            <span>option</span>
                                        </label>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body py-4">
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                ...
                                @foreach($Product as $key => $ProductI)
                                    <tr>
                                        <td>{{ $key+1 }}</td>
                                        ...
                                        <td>
                                            <div class="badge badge-light fw-bold d-block">Cat: {{ $ProductI->category_name }}</div>
                                            <div class="badge badge-light fw-bold d-block">Sto: {{ $ProductI->store_name }}</div>
                                        </td>
...
@section('script')
    <script>
        ...
        $('#ProductSearch').click(function () {
            ...
            window.location.replace("/product-list?product_id="+product_id+"&category_id="+category_id+"&store_id="+store_id);
        });
