        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Property Type List</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Property Type List</li>
                        <!--end::Item-->
                ...
                <div class="row">
                    <div class="card mb-5 mb-xl-8">
                        <div class="card-body">
                            ...
                            <form action="{{ route('property-type.entry')}}" method="post" class="form" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="fv-row mb-5 fv-plugins-icon-container">
                                            ...
                                            <input type="text" class="form-control form-control-lg form-control-solid" name="property_type_name" placeholder="" value="" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="fv-row mb-5 fv-plugins-icon-container">
                                            ...
                                            <textarea name="property_type_details" class="form-control form-control form-control-solid" data-kt-autosize="true"></textarea>
                                        </div>
                                    </div>
                                                    ...
                                                    @foreach($Features as $Feature)
                                                        <div class="col-lg-3 col-md-4 col-sm-6 mb-2">
                                                            <label class="form-check form-check-sm form-check-custom form-check-solid me-5">
                                                                <input class="form-check-input" type="checkbox" name="features[]" value="{{$Feature->features_id}}">
                                            ...
                                            <div class="row">
                                                ...
                                                @if(!$ConsumerType->isEmpty())
                                                    @foreach($ConsumerType as $ConsumerT)
                                                        <div class="col-lg-3 col-md-4 col-sm-6 mb-2">
                                                            <label class="form-check form-check-sm form-check-custom form-check-solid me-5">
                                                                <input class="form-check-input" type="checkbox" name="consumer_type[]" value="{{ $ConsumerT->consumer_type_id }}">
