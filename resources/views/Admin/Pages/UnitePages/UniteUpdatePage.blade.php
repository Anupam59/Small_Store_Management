        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Unite Update</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Unite Update</li>
                        <!--end::Item-->
                ...
                <div class="row">
                    <div class="card mb-5 mb-xl-8">
                        <div class="card-body">
                            ...
                            <form action="{{ url('/unite-update/'.$Unite->unite_id)}}" method="post" class="form" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="fv-row mb-5 fv-plugins-icon-container">
                                            ...
                                            <input type="text" class="form-control form-control-lg form-control-solid" name="unite_name" placeholder="" value="{{ $Unite->unite_name }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="fv-row mb-5 fv-plugins-icon-container">
                                            ...
                                            <select name="status" aria-label="Select a Timezone" data-control="select2" data-placeholder="Select Role" class="form-control form-control-lg form-control-solid" required>
                                                <option value="1" @if($Unite->status == "1") {{ 'selected' }} @endif>Active</option>
                                                <option value="2" @if($Unite->status == "2") {{ 'selected' }} @endif>Inactive</option>
                                            </select>
                                        </div>
                                    </div>
