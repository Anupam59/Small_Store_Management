                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="fv-row mb-5 fv-plugins-icon-container">
                                            ...
                                            <input type="text" class="form-control form-control-lg form-control-solid" name="username" placeholder="" value="" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="fv-row mb-5 fv-plugins-icon-container">
                                            ...
                                            <input type="tel" class="form-control form-control-lg form-control-solid" name="number" placeholder="" value="" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="fv-row mb-5 fv-plugins-icon-container">
                                            ...
                                            <select name="role" aria-label="Select a Timezone" data-control="select2" data-placeholder="Select Role" class="form-control form-control-lg form-control-solid" required>
